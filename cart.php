...
<body>
            ...
            <form action="./order.php" method="POST">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-danger" id="submit">Order Now</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="container mt-2">
        ...
        if($unique_items <= 0){
            echo "<h6 class='display-4 text-danger text-center'>Your cart is empty</h6>";
        }else{
        ?>
...
<script>
    ...
    function showalert(err, desired_count, btn_addtocart, input_cart_count) {
        console.log(err);
        if (err[1].toString() == "false") {
            body.insertAdjacentHTML('afterbegin', '<div class="alert alert-danger shadow a-msg" role="alert" id="logedin-alert">Sorry! Please log in to add items in your cart </div>');
            ...
            body.insertAdjacentHTML('afterbegin', '<div class="alert alert-danger shadow a-msg" role="alert" id="logedin-alert">Sorry! ' + err[0] + ' </div>');
        } else {
            let db_count = err[1];
            ...
            if (desired_count == 1 && db_count >= 1) {
                ...
                input_cart_count.value = db_count;
                err_msg = 'Sorry! you have already removed this item from cart (Try again to edit).';
    ...
    submit.addEventListener('click', (e) => {
        if (parseInt(total_amount.innerText) <= 0) {
            e.preventDefault();
        }
