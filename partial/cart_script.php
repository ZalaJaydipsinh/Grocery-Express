    ...
    function showalert(err, desired_count, btn_addtocart, input_cart_count) {
        ...
        if (err[1].toString() == "false") {
            ...
            if (desired_count == 1 && db_count >= 1) {
                ...
                // input_cart_count.value = db_count; change on 14/01/2021
                input_cart_count.value = 1;
                err_msg = 'Sorry! you have already removed this item from cart (Try again to insert).';
